...
public class HomeService {
    ...
    public HomeService(PlaceRepository placeRepasitory, StoreRepository storeRepasitory, ProductRepository productRepository) {
    ...
    // 홈페이지 접속시 card출력
    @Transactional
    public List<Place> homeCoordinates(HomeCoordinatesRequest req) {
...
//        double longtitude2 = req.getLongtitude()+0.0000000000003;
    ...
    // 홈페이지에서 카드쪽 더보기 클릭시
    @Transactional
    public List<Place> AllSelect(HomeCoordinatesRequest req) {
